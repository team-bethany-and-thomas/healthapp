    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white shadow rounded-lg mb-8">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-600">
              Upload images and documents to your personal storage.
            </p>
          </div>
          <div className="p-6">
            <UploadFile
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-blue-600 mt-1">
                  Selected files can be attached to forms or used in other parts of the application.
                </p>
              </div>
              <button
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="p-6">
            <UploadTable
              key={refreshTable} // Force re-render when files are uploaded
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm text-gray-600 space-y-2">
                  ...
                  <li>• Supports images, PDFs, Word docs, Excel files, and text files</li>
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-900 mb-3">Manage Files</h3>
                <ul className="text-sm text-gray-600 space-y-2">
        ...
        {/* Integration Example */}
        <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-xl font-semibold text-gray-900">Integration with Intake Forms</h2>
          </div>
          <div className="p-6">
            <p className="text-sm text-gray-600 mb-4">
              The file upload system is designed to work seamlessly with patient intake forms. Here&apos;s how you can integrate it:
            </p>
            <div className="bg-white p-4 rounded border">
              <h4 className="font-medium text-gray-900 mb-2">Example Integration:</h4>
              <pre className="text-xs bg-gray-100 p-3 rounded overflow-x-auto">
{`// In your intake form component
import UploadTable from '../../../components/UploadTable';

// Add file selection to your form
...
<UploadTable
  ...
  allowMultipleSelection={true}
  showSelectionColumn={true}
  category="medical-documents" // Optional: filter by category
/>`}
              </pre>
            </div>
          </div>
